...
const ROUTING_TABLE: RoutingEntry[] = [
  // ── HR임팩트본부 / 출근보고
  { department: 'HR임팩트본부', teamName: '디크3파트', reportType: '출근보고',
  ...
  { department: 'HR임팩트본부', teamName: '컬컴팀', reportType: '출근보고',
  ...
  { department: 'HR임팩트본부', teamName: '비즈팀', reportType: '출근보고',
  ...
  // ── HR임팩트본부 / 퇴근보고
  { department: 'HR임팩트본부', teamName: '디크3파트', reportType: '퇴근보고',
  ...
  { department: 'HR임팩트본부', teamName: '컬컴팀', reportType: '퇴근보고',
  ...
  { department: 'HR임팩트본부', teamName: '비즈팀', reportType: '퇴근보고',
  ...
  // ── HR마케팅본부 / 출근보고
  { department: 'HR마케팅본부', teamName: '디크2파트', reportType: '출근보고',
  ...
  { department: 'HR마케팅본부', teamName: '마1팀', reportType: '출근보고',
  ...
  { department: 'HR마케팅본부', teamName: '마2팀', reportType: '출근보고',
  ...
  { department: 'HR마케팅본부', teamName: '마3팀', reportType: '출근보고',
  ...
  // ── HR마케팅본부 / 퇴근보고
  { department: 'HR마케팅본부', teamName: '디크2파트', reportType: '퇴근보고',
  ...
  { department: 'HR마케팅본부', teamName: '마1팀', reportType: '퇴근보고',
  ...
  { department: 'HR마케팅본부', teamName: '마2팀', reportType: '퇴근보고',
  ...
  { department: 'HR마케팅본부', teamName: '마3팀', reportType: '퇴근보고',
