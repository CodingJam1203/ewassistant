  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 bg-surface rounded-lg shadow-sm border border-border my-8">
      ...
      <div className="max-w-none leading-relaxed text-text-primary space-y-6">
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">제4조 서비스 주요 기능</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">제5조 사용자의 의무</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">제6조 관리자의 권한</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">제7조 제출 내역의 수정 및 삭제</h2>
          <ol className="list-decimal pl-5 space-y-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">제8조 서비스 이용 제한</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">제9조 서비스 변경 및 중단</h2>
          <p>회사는 업무상 필요, 시스템 점검, 보안 문제, 기능 개선 등을 위해 서비스의 전부 또는 일부를 변경하거나 중단할 수 있습니다.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">제10조 책임 제한</h2>
          <p>본 서비스는 내부 업무 편의를 위한 보조 시스템입니다.</p>
          <p>사용자는 입력 내용의 정확성에 책임이 있으며, 시스템 오류 또는 누락이 발견될 경우 관리자에게 즉시 알려야 합니다.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">제11조 약관 변경</h2>
