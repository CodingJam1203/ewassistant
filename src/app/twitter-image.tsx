// Twitter 카드 이미지 — opengraph-image와 동일 디자인.
// (Next.js 제약: runtime 등 route segment config는 re-export 불가, 직접 선언 필요)
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ fontSize: 28, color: '#475569', fontWeight: 500 }}>
